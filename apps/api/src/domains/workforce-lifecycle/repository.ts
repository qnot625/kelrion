...
export interface WorkforceLifecycleRepository {
  ...
  listLeaveRequests(tenantId: string, requesterUserId?: string): Promise<LeaveRequest[]>;
  ...
  listLifecyclePlans(tenantId: string, subjectUserId?: string): Promise<LifecyclePlan[]>;
}
